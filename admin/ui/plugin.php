...
$extensions = array(
    '1' => (object) array(
        ...
        'url'       => SIP_SPWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_SPWC_PLUGIN_VERSION .'&utm_campaign=' .SIP_SPWC_UTM_CAMPAIGN,
    ...
    '2' => (object) array(
        ...
        'url'       => SIP_FEBWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_SPWC_PLUGIN_VERSION .'&utm_campaign=' .SIP_SPWC_UTM_CAMPAIGN,
    ...
    '3' => (object) array(
        ...
        'url'       => SIP_RSWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_SPWC_PLUGIN_VERSION .'&utm_campaign=' .SIP_SPWC_UTM_CAMPAIGN,
	...
	'4' => (object) array(
		...
		'url'       => SIP_AENWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_SPWC_PLUGIN_VERSION .'&utm_campaign=' .SIP_SPWC_UTM_CAMPAIGN,
		'title'     => SIP_AENWC_PLUGIN,
		'desc'      => __( 'Powerful email automation.', 'sip-social-proof' ),
	),
    '5' => (object) array(
      'image_url' => $src_image . 'icon-cookie-check.png',
      'url'       => SIP_CCWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_SPWC_PLUGIN_VERSION .'&utm_campaign=' .SIP_SPWC_UTM_CAMPAIGN,
